(function(c) {
console.log("GIF - C:", c);
    document.getElementById("gifstatus").value += "GIF - " + c.frames + " frames o extract....\n";
    function a(b, d) {
            ...
            return i(a, d), c = {
                ...
                this.running = !0, this.nextFrame = 0, this.finishedFrames = 0, this.imageParts = function(c) {
                    for (var b = function() {
                            ...
                            return b
                        }.apply(this, arguments), a = 0, e = b.length; a < e;
                        ++a) d = b[a], c.push(null);
                    return c
                ...
                for (var c = function() {
                        ...
                        return c
                    }.apply(this, arguments), b = 0, e = c.length; b < e;
                    ++b) d = c[b], this.renderNextFrame();
                ...
                for (var g = 0, l = this.imageParts.length; g < l;
                    ++g) {
                    a = this.imageParts[g];
                    for (var c = 0, i = a.data.length; c < i;
                        ++c) h = a.data[c], k = c, e.set(h, d), k === a.data.length - 1 ? d += a.cursor : d += a.pageSize
                }
                return m = new Blob([e], {
                    type: 'image/gif'
                ...
                document.getElementById("gifstatus").value += "GIF - " + 'starting frame ' + (a.index + 1) + ' of ' + this.frames.length + "\n";
