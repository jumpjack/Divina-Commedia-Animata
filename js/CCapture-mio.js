...
console.log("SETTINGS:",settings);
	...
	this.filename = settings.name; // added
	this.extension = '.gif';
...
console.log("callback",callback);
		if( !callback ) {
			callback = function( blob ) {
				_log(blob);
				_log(_encoder.filename);
				_log(_encoder.extension);
				_log(_encoder.mimeType);
	...
	function _log( message ) {
		if( _verbose ) {
			console.log(message);
			gifstatus.value += "CCAPTURE global - " + message + "\n";
